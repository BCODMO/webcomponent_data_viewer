...
import { html, internalProperty, LitElement, property, query } from "../../lit-element/lit-element.js";
...
export class LinearProgressBase extends LitElement {
  ...
  connectedCallback() {
    super.connectedCallback(); // if detached and reattached
  ...
  update(changedProperties) {
    ...
    if (changedProperties.has('closed') && (!this.closed || changedProperties.get('closed') === undefined)) {
  ...
  updated(changed) {
    ...
    if (changed.has('indeterminate') && changed.get('indeterminate') !== undefined && this.indeterminate && window.ResizeObserver) {
  ...
  calculateAndSetAnimationDimensions(width) {
    ...
    this.styleSecondaryFull = `${secondaryFull}px`; // need to restart animation for custom props to apply to keyframes
...
__decorate([query('.mdc-linear-progress')], LinearProgressBase.prototype, "rootEl", void 0);
...
__decorate([internalProperty()], LinearProgressBase.prototype, "stylePrimaryHalf", void 0);

__decorate([internalProperty()], LinearProgressBase.prototype, "stylePrimaryFull", void 0);

__decorate([internalProperty()], LinearProgressBase.prototype, "styleSecondaryQuarter", void 0);

__decorate([internalProperty()], LinearProgressBase.prototype, "styleSecondaryHalf", void 0);

__decorate([internalProperty()], LinearProgressBase.prototype, "styleSecondaryFull", void 0);

__decorate([internalProperty()], LinearProgressBase.prototype, "animationReady", void 0);

__decorate([internalProperty()], LinearProgressBase.prototype, "closedAnimationOff", void 0); //# sourceMappingURL=mwc-linear-progress-base.js.map